  ...
  return (
    <div className="card text-center">
      <div className="card-header">
        <h6 className="card-title">Étape 1</h6>
      </div>
      <div className="card-body px-2 py-2">
        <form id="form-1" className="needs-validation" autoComplete="off" noValidate onSubmit={handleSubmit}>
            ...
            <table className="table table-striped table-hover table-1">
              <tbody>
                {formData.stepResult1.map((drug, index) => (
                  <tr key={index} data-name="step1" data-value={`${drug.name} : ${new Intl.NumberFormat('de-DE').format(drug.price)} CFA`} data-result="stepResult1">
          ...
          <div className="form-group">
            <button type="submit" name="add" className="btn btn-outline-success rounded-lg">Ajoutez un autre médicament</button>
