...
export const FETCH_ORDER_DELIVERY = 'FETCH_ORDER_DELIVERY';
export const FETCH_ORDER_PAYMENT = 'FETCH_ORDER_PAYMENT';
export const FETCH_ORDER_COPY = 'FETCH_ORDER_COPY';
